...
| Target player | _(TBD — the 타깃 유저 대변인 expert scores against this; it must be concrete)_ |
| Project folder | _(TBD)_ |

> When the first brief arrives, the PM fills this table and tunes §3.2/§3.3 for the project.
