...
**Conflict with ADDENDUM-02 R-5 (random placement), resolved (director, 2026-08-09):** chronological placement is implemented but NOT enabled; random placement (ADDENDUM-02 R-5) remains the shipped behaviour (`MONUMENT_CHRONOLOGICAL_PLOTS`, `settlementActions.ts`).
