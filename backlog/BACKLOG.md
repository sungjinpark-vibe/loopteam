...
| T010 | Playable gameplay slice — tap building → timer → growth | `in-progress` | client-dev | build | 2 | Director-approved next step (2026-07-17) + reconfirmed 2026-07-19. Wire Economy.Core (T002) + Platform (T003) + design system (T004) into the village scene. Full quality loop. After T009. |
