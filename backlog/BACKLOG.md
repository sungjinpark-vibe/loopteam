...
| T003 | P0-C — 3-phase session + solo run to completion | `in-progress` | client-dev | build | 3 | Unblocked — T002 done. quality-loop running (클라이언트팀장, 90). GDD §5.1; groggy rush guaranteed once per phase transition. |
