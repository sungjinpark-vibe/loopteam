...
| T012 | Art resource upgrade — Blender-modeled village landmark | `blocked` | ui-ux | build | 1 | **3rd escalation.** 15 rounds, 3 full attempts (44/66/60 final), score never converges toward 95 despite genuine fixes each round. Not relaunching a 4th attempt without a real director decision — see task log. |
